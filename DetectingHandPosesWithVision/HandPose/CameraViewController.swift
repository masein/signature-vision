...
class CameraViewController: UIViewController {
    ...
    var evidenceBuffer = [HandGestureProcessor.PointsPair]()
    ...
    override func viewDidLoad() {
        ...
        colorOptions.delegate = self
        colorOptions.translatesAutoresizingMaskIntoConstraints = false
        colorOptions.backgroundColor = .link.withAlphaComponent(0.7)
        colorOptions.layer.cornerRadius = 12
        NSLayoutConstraint.activate([
            colorOptions.centerXAnchor.constraint(equalTo: view.centerXAnchor),
            colorOptions.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -15),
            colorOptions.heightAnchor.constraint(equalToConstant: 65),
            colorOptions.widthAnchor.constraint(equalToConstant: 300)
        ])
    }
    ...
    private func handleGestureStateChange(state: HandGestureProcessor.State) {
        ...
        let pointsPair = (pointsFingers.thumb.TIP, pointsFingers.index.TIP)
        ...
        case .possiblePinch, .possibleApart:
            ...
            tipsColor = .orange
            cameraView.showPoints([pointsFingers.thumb.TIP, pointsFingers.index.TIP], color: tipsColor)
        case .pinched:
